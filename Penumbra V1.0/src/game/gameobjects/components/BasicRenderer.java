...
public class BasicRenderer implements RenderingComponent {
	...
	public BasicRenderer(RenderableCharacter renderable, ArrayList<BufferedImage[]> sprites, int[] delays, Camera camera){
